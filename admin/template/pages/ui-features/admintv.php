...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="../../assets/images/fTeam_Flash_logo.png" />
  </head>
  <body>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <?php
                            $thanhvien = "SELECT*FROM thanhvien";
                            $kqtv = mysqli_query($conn,$thanhvien);
                            while($rowtv = mysqli_fetch_array($kqtv)){
                              ?>
                              <tr>
                                <td><?php echo $rowtv['id'] ?></td>
                                <td><img src="../../assets/images/<?php echo $rowtv['hinhanh'] ?>" alt=""></td>
                                <td><?php echo $rowtv['tentv'] ?></td>
                                <td><?php echo $rowtv['vitri'] ?></td>
                                
                                <td><?php echo $rowtv['idtheloai'] ?></td>
                                
                                <td>
                                <a href="suatv.php?id=<?php echo $rowtv['id'] ?>"> <div class="badge badge-outline-success"><i class="mdi mdi-wrench"></i></div></a>
                                </td>
                                <td><a href="xoatv.php?id=<?php echo $rowtv['id'] ?>"> <label class="badge badge-danger"><i class="mdi mdi-window-close"></i></label></a></td>
                    ...
                    <h4 class="card-title">Thêm Thành Viên</h4>
                      ...
                      <form class="forms-sample" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputUsername1" name="tentv" placeholder="Tên Thành Viên">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Vị Trí</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Vị Trí" name="vitri">
                        </div>
                       
                        <div class="form-group">
                        <label for="exampleSelectGender">Tựa Game</label>
                        <select class="form-control" id="exampleSelectGender" name="idtheloai" style="color: white;">
                            <?php
                              $loai = "SELECT*FROM theloai";
                              $kqloai = mysqli_query($conn,$loai);
                              while($rowop = mysqli_fetch_array($kqloai)){
                                echo '<option style="color: white;" value="'.$rowop['id'].'">'.$rowop['theloai'].'</option>';
                              }
                            ?>
                        </select>
                        </div>
                    ...
                    if($tentv =="" || $vitri == "" || $idtheloai == ""){
                      ...
                      if($_FILES["img"]["error"] === 4){
                        ...
                        if(!in_array($imageExtension, $validImageExtension)){
                          ...
                          $themtv = "INSERT INTO thanhvien(tentv, vitri, hinhanh, idtheloai) VALUE('$tentv','$vitri','$filename', $idtheloai)";
                          $kqtv = mysqli_query($conn, $themtv);
