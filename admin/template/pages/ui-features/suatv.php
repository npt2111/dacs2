              ...
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                            $sua = "SELECT*FROM thanhvien WHERE id=".$_GET['id'];
                            $kqsua = mysqli_query($conn,$sua);
                            $tt = mysqli_fetch_array($kqsua);
                        ?>
                    <form class="forms-sample" method="POST"  enctype="multipart/form-data">
                            <input type="hidden" name="idtv" value="<?php echo $tt['id'] ?>">
                            <div class="form-group">
                            <label for="exampleInputUsername1">Tên Thành Viên</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" name="tentv" placeholder="Tên Thành Viên" value="<?php echo $tt['tentv'] ?>"> 
                            </div>
                            <div class="form-group">
                            <label for="exampleInputEmail1">Vị Trí</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Vị Trí" name="vitri" value="<?php echo $tt['vitri'] ?>">
                            </div>
                        
                            <div class="form-group">
                            <label for="exampleSelectGender">Tựa Game</label>
                            <select class="form-control" id="exampleSelectGender" name="idtheloai" style="color: white;" value="<?php echo $tt['idtheloai'] ?>">
                                <?php
                    ...
                    $idtl = $_POST['idtheloai'];
                        ...
                        if($_FILES["img"]["error"] === 4){
                            ...
                            $filetmpName = $_FILES["img"]["tmp_name"];
                                ...
                                $sqlupdate = "UPDATE thanhvien SET tentv='$tentv', vitri='$vitri' , hinhanh='$filename', idtheloai='$idtheloai' WHERE id='$idtv'";
