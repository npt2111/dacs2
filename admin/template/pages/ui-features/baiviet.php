                  ...
                  <h4 class="card-title">Danh Sách Bài Viết</h4>
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <?php
                            $baiviet = "SELECT*FROM tintuc";
                            $kqbv = mysqli_query($conn, $baiviet);
                            while($rowbv = mysqli_fetch_array($kqbv)){
                              ?>  
                            <tr>
                                <td><?php echo $rowbv['id'] ?></td>
                                <td><?php echo $rowbv['tieude'] ?></td>
                                <td><?php echo $rowbv['date'] ?></td>
                                <td>
                                   <a href="suabv.php?id=<?php echo $rowbv['id'] ?>"> <div class="badge badge-outline-success"><i class="mdi mdi-wrench"></i></div></a>
                                </td>
                                <td><a href="xoabv.php?id=<?php echo $rowbv['id'] ?>"> <label class="badge badge-danger"><i class="mdi mdi-window-close"></i></label></a></td>
                            </tr>
                              <?php
                            }
                          ?>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="tieude">
                      </div>
                      <div class="form-group">
                        <input type="date" class="form-control" id="exampleInputName1" placeholder="Name" name="date" >
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="noidung"></textarea>
                      </div>
                    ...
                    if($tieude == "" || $noidung == "" || $date == ""){
                      ...
                      if($_FILES["img"]["error"] === 4){
                        ...
                        if(!in_array($imageExtension, $validImageExtension)){
                          ...
                          $thembv = "INSERT INTO tintuc(tieude, hinhanh, date, noidung) VALUES('$tieude','$filename','$date','$noidung')";
                          $kqthembv = mysqli_query($conn, $thembv);
