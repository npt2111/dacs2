                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST">
                        <?php
                            $sua = "SELECT*FROM loaisanpham WHERE id=".$_GET['id'];
                            $kqsua = mysqli_query($conn,$sua);
                            $tt = mysqli_fetch_array($kqsua);
                        ?>
                      <div class="form-group">
                        <input type="hidden" name="iddm" value="<?php echo $tt['id'] ?>">
                        <label for="exampleInputUsername1">Tên Danh Mục</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Tên Danh mục" name="tendm" value="<?php echo $tt['loaisanpham'] ?>">
                      </div>
             ...
             <?php
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                  ...
                  if($loaisanpham == ""){
                    ...
                    $suadanhmuc = "UPDATE loaisanpham SET loaisanpham='$loaisanpham' WHERE id='$iddm'";
                    $kqthem = mysqli_query($conn, $suadanhmuc);
