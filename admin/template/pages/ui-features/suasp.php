                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                        <?php
                            $sua = "SELECT*FROM sanpham WHERE id=".$_GET['id'];
                            $kqsua = mysqli_query($conn,$sua);
                            $tt = mysqli_fetch_array($kqsua);
                        ?>
                      <div class="form-group">
                        <input type="hidden" name="idsp" value="<?php echo $tt['id'] ?>">
                        <label for="exampleInputUsername1">Tên Sản Phẩm</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Tên Danh mục" name="tensp" value="<?php echo $tt['tensp'] ?>">
                      </div>
                      <div class="form-group">
                          <label for="exampleInputEmail1">Giá</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Giá" name="gia" value="<?php echo $tt['gia'] ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Số Lượng</label>
                          <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Số Lượng" name="soluong" value="<?php echo $tt['soluong'] ?>">
                        </div>
                        <div class="form-group">
                    ...
                    if($tensp == "" || $gia == "" || $soluong == "" || $idlsp == ""){
                      ...
                      if($_FILES["img"]["error"] === 4){
                        ...
                        if(!in_array($imageExtension, $validImageExtension)){
                          ...
                          $sua = "UPDATE sanpham SET tensp='$tensp', gia='$gia', soluong='$soluong', idlsp='$idlsp', hinhanh='$filename' WHERE id='$idsp'";
                         $kqsua = mysqli_query($conn, $sua);
