  ...
  <section>
        <div class="form-box">
            <form action="xulydangbai.php" method="POST" enctype="multipart/form-data">
                <div class="input" >
                   <input type="text" name="tieude" placeholder="Tiêu đề" style="color: white;"><br>
                   <input type="date" name="date"  style="color: white; background-color: black;"><br>
                   <input type="file" name="hinhanh" id="hinhanh"><br>
                   <input type="text" name="noidung" placeholder="Nội dung" style="color: white;">
                </div>
                <input type="submit" name="submit" value="Đăng bài" style="background-color: orange;">
            </form>
        </div>
