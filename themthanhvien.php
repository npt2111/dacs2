...
<br><br><br><br><br><br>
  ...
  <section>
        <div class="form-box">
            <form action="xulythemtv.php" method="POST" enctype="multipart/form-data">
                <div class="input" >
                    <input type="text" name="tentv" placeholder="Tên thành viên" style="color: white;"><br>
                    <input type="text" name="vitri" placeholder="Vị trí" style="color: white;">
                    <div style="display: flex;">
                    <input type="file" name="image" id="image" style="color: white;">
                    </div>
                    <div>
                        <select name="idtl" id="idtl" style="color: white; bgcolor: black;">
                            <?php
