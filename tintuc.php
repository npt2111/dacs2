...
<br><br><br>
    ...
    <section class="site-banner jarallax min-height300 padding-large" style="background: url(admin/template/assets/images/slider_2.jpg) no-repeat; background-position: top; height: 900px;">
      
      </section>
      <section class="tieude">

      <div class="post-meta">
              <a href="index.php"><span class="post-date" style="color: orange;">Trang chủ</span></a> / <a href="tintuc.php" style="color: grey;">Tin tức</a>
      </div>
      <div>
        <h1 style="text-align: center; color: gray;">TIN TỨC</h1>
      </div>
      </section>
      <section>
      <?php
        if(isset($_SESSION['admin'])){
          ?>
            <div class="btn-db">
              <button style="background-color: orange; border-radius: 50px;"><a href="dangbaitintuc.php" style="color: white;">Đăng bài</a></button>
            </div>
          <?php
        }
      ?>
        ...
        <div class="container">
          <div class="row d-flex flex-wrap">
            <?php
              ...
              while($row = mysqli_fetch_array($kqtt)){
            ?>
            <article class="col-md-4 post-item">
              ...
              <div class="post-content d-flex">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="chitiettintuc.php?id=<?php echo $row['id'] ?>" style="color: white; text-align: justify;"><?php echo $row['tieude'] ?></a>
                  </h3>
                  <a href="blog.html" class="blog-categories"><?php echo $row['date'] ?></a>
                </div>
              </div>
              <?php 
              if(isset($_SESSION['admin'])){
                ?>
                  <div>
                    <button style="border-color: green; border-radius: 50px;"><a href="suatt.php?id=<?php echo $row['id']?>" style="color: white;">Chỉnh sửa</a></button>
                    <button style="border-color: red; border-radius: 50px;"><a href="xoatt.php?id=<?php echo $row['id']?>" style="color: white;">Xóa</a></button>
                  </div>
                  <?php
              }
              ?>
