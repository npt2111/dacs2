  ...
  <section>
        <div class="form-box">
            <form action="xulythemsp.php" method="POST" enctype="multipart/form-data">
                <div class="input" >
                    <input type="text" name="tensp" placeholder="Tên sản phẩm" style="color: white;"><br>
                    <input type="text" name="gia" placeholder="Giá" style="color: white;"><br>
                    <input type="text" name="soluong" placeholder="Số lượng" style="color: white;"><br>
                    <div style="display: flex;">
                    <input type="file" name="image" id="image" style="color: white;">
                    </div>
                    <div>
                        <select name="idlsp" id="idtl" style="color: white; bgcolor: black;">
                            <?php
                ...
                <input type="submit" name="submit" value="Thêm" style="background-color: orange;">
            </form>
        </div>
