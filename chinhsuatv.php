...
<br><br><br><br><br><br>
  ...
  <section>
                <?php 
                    $show = "SELECT*FROM thanhvien WHERE id=".$_GET['id'];
                    $kqshow = mysqli_query($conn, $show);
                    $thongtin = mysqli_fetch_array($kqshow);
                ?>
        <div class="form-box">
            <form action="xulysuatv.php" method="POST" enctype="multipart/form-data">
               
                <div class="input" >
                    <input type="hidden" name="idtv" value="<?php echo $thongtin['id'] ?>">
                    <input type="text" name="tentv" placeholder="Tên thành viên" style="color: white;" value="<?php echo $thongtin['tentv'] ?>"><br>
                    <input type="text" name="vitri" placeholder="Vị trí" style="color: white;" value="<?php echo $thongtin['vitri'] ?>">
                    <div style="display: flex;">
                    <input type="file" name="image" id="image" style="color: white;" value="<?php echo $thongtin['hinhanh'] ?>">
                    </div>
                    <div>
                        <select name="idtl" id="idtl" style="color: white; bgcolor: black;" value="<?php echo $thongtin['theloai'] ?>">
                            <?php
                            $sqlop = "SELECT*FROM theloai";
                            $kqop = mysqli_query($conn, $sqlop);
                            while($row = mysqli_fetch_array($kqop)){
                                echo '<option style="color: black;" value="'.$row['id'].'">'.$row['theloai'].'</option>';
                            }
                            ?>
                        </select>
                    </div>  
