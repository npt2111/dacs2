...
<br><br><br>
        ...
        <div id="lienquan">
        <h2 style="color: gray;">Liên Quân Mobile</h2>
        ...
        <div id="lmht">
        <h2 style="color: gray;">Liên Minh Huyền Thoại</h2>
        <table class="table" style="width: 100%;">
        <thead class="thead-dark">
            <tr>
            <th scope="col">#</th>
        ...
        <div id="ff">
        <h2 style="color: gray;">Free Fire</h2>
        <table class="table" style="width: 100%;">
        <thead class="thead-dark">
            <tr>
            <th scope="col">#</th>
        ...
        <div id="tc">
        <h2 style="color: gray;">Liên Minh Tốc Chiến</h2>
        <table class="table" style="width: 100%;">
        <thead class="thead-dark">
            <tr>
            <th scope="col">#</th>
