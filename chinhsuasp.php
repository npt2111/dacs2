...
<br><br><br><br><br><br>
  ...
  <section>
                <?php 
                    $show = "SELECT*FROM sanpham WHERE id=".$_GET['id'];
                    $kqshow = mysqli_query($conn, $show);
                    $thongtin = mysqli_fetch_array($kqshow);
                ?>
        <div class="form-box">
            <form action="xulysuasp.php" method="POST" enctype="multipart/form-data">
               
                <div class="input" >
                    <input type="hidden" name="idsp" value="<?php echo $thongtin['id'] ?>">
                    <input type="text" name="tensp" placeholder="Tên sản phẩm" style="color: white;" value="<?php echo $thongtin['tensp'] ?>"><br>
                    <input type="text" name="gia" placeholder="Giá" style="color: white;" value="<?php echo $thongtin['gia'] ?>"><br>
                    <input type="text" name="soluong" placeholder="Số lượng" style="color: white;" value="<?php echo $thongtin['soluong'] ?>">
                    <br>
                    <div style="display: flex;">
                    <input type="file" name="hinhanh" id="hinhanh" style="color: white;" value="<?php echo $thongtin['hinhanh'] ?>">
                    </div>
                    <div>
                        <select name="idlsp" id="idlsp" style="color: white; bgcolor: black;" value="<?php echo $thongtin['idlsp'] ?>">
                            <?php
                            $sqlop = "SELECT*FROM loaisanpham";
                            $kqop = mysqli_query($conn, $sqlop);
                            while($row = mysqli_fetch_array($kqop)){
                                echo '<option style="color: black;" value="'.$row['id'].'">'.$row['loaisanpham'].'</option>';
                            }
                            ?>
                        </select>
                    </div>  
