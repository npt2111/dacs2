                ...
                <div class="navbar">
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="#" class="item-anchor active d-flex align-item-center" data-effect="Shop">Thi đấu<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
...
<br><br><br>
  ...
  <div class="container">
    <div class="row">
      <div class="col12">
        <h1 style="color: gray;">Liên Quân Mobile</h1>
        <h2 style="color: gray;">Xếp hạng: DTDV Mùa Đông 2023</h2>
      </div>
    </div>
  </div>
</div>
<table class="table" style="width: 100%;">
        ...
        <tbody>
            <tr>
            <th scope="row" style="font-weight: bold; color: yellow;"><i>1</i></th>
            <td><img src="" alt=""></td>
            <td>SaigonPhantom</td>
            <td>#SGP</td>
            <td>31</td>
            ...
            <tr>
            <th scope="row" style="font-weight: bold; color: white;"><i>2</i></th>
            <td><img src="" alt=""></td>
            <td>V Gaming</td>
            <td>#VGM</td>
            <td>30</td>
            ...
            <tr>
            <th scope="row" style="font-weight: bold; color: brown;"><i>3</i></th>
            <td><img src="" alt=""></td>
            <td>GG Live</td>
            <td>#GGL</td>
            <td>28</td>
  ...
  <div class="container">
    <div class="row">
      <div class="col12">
        <h1 style="color: gray;">Liên Minh Huyền Thoại</h1>
        <h2 style="color: gray;">Xếp hạng: DTDV Mùa Đông 2023</h2>
      </div>
    </div>
  </div>
...
<table class="table" style="width: 100%;">
  ...
  <div class="container">
    <div class="row">
      <div class="col12">
        <h1 style="color: gray;">Liên Minh Tốc Chiến</h1>
        <h2 style="color: gray;">Xếp hạng: DTDV Mùa Đông 2023</h2>
      </div>
    </div>
  </div>
...
<table class="table" style="width: 100%;">
  ...
  <div class="container">
    <div class="row">
      <div class="col12">
        <h1 style="color: gray;">Free Fire</h1>
        <h2 style="color: gray;">Xếp hạng: DTDV Mùa Đông 2023</h2>
      </div>
    </div>
  </div>
